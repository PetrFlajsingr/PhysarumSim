...
bool areBufferFlagsMutable(GLbitfield flags) {
  return flags == GL_STATIC_DRAW || flags == GL_STATIC_COPY || flags == GL_STATIC_READ || flags == GL_STREAM_DRAW
      || flags == GL_STREAM_COPY || flags == GL_STREAM_READ || flags == GL_DYNAMIC_DRAW || flags == GL_DYNAMIC_COPY
...
unsigned internalFormatSize(GLenum internalFormat) {
  switch (internalFormat) {
    case GL_STENCIL_INDEX1: return 1;
    case GL_STENCIL_INDEX4: return 4;
    case GL_R8:
    case GL_R8UI:
    case GL_R8I:
    case GL_R8_SNORM:
    ...
    case GL_RGB5: return 16;//TODO CHECK
    ...
    case GL_STENCIL_INDEX16: return 16;
    ...
    case GL_RGB16F:
    case GL_RGB16I:
    case GL_RGB16UI: return 3 * 16;
    case GL_RGBA16F:
    case GL_RGBA16I:
    case GL_RGBA16UI: return 4 * 16;
    case GL_RGBA32F:
    case GL_RGBA32UI:
    case GL_RGBA32I: return 4 * 32;
  }
  return 32;//TODO
}
