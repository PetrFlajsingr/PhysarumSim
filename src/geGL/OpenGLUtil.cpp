...
bool areBufferFlagsMutable(GLbitfield flags) {
  return flags == GL_STATIC_DRAW || flags == GL_STATIC_COPY || flags == GL_STATIC_READ || flags == GL_STREAM_DRAW || flags == GL_STREAM_COPY || flags == GL_STREAM_READ || flags == GL_DYNAMIC_DRAW || flags == GL_DYNAMIC_COPY || flags == GL_DYNAMIC_READ;
}
  ...
  CompressedInternalFormatElement const static elements[] = {
      {
          ...
          GL_RED,
          true,
          CompressedInternalFormatElement::UNORM,
      },
      {
          GL_COMPRESSED_RG,
          "GL_COMPRESSED_RG",
      ...
      },
      {
          ...
          GL_RED,
          false,
          CompressedInternalFormatElement::SNORM,
      },
      {
      ...
      },
      {
          ...
          GL_RGB,
          false,
          CompressedInternalFormatElement::FLOAT,
      },
      {
...
bool basicInternalFormatTable(BasicInternalFormatElement &info, GLenum internalFormat) {
  BasicInternalFormatElement const static elements[] = {
      {GL_R8, "GL_R8", "            ", GL_RED, 1, {
       ...
       true,
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_R8_SNORM, "GL_R8_SNORM", "      ", GL_RED, 1, {
                                                            8,
                                                            0,
                                                            0,
                                                            0,
       ...
       false,
       true,
       BasicInternalFormatElement::FIXED_POINT},
      {GL_R16, "GL_R16", "           ", GL_RED, 1, {
                                                       16,
                                                       0,
                                                       0,
                                                       0,
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_R16_SNORM, "GL_R16_SNORM", "     ", GL_RED, 1, {
                                                             16,
                                                             0,
                                                             0,
                                                             0,
      ...
      {GL_RG8, "GL_RG8", "           ", GL_RG, 2, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RG8_SNORM, "GL_RG8_SNORM", "     ", GL_RG, 2, {
                                                            8,
                                                            8,
                                                            0,
                                                            0,
      ...
      {GL_RG16, "GL_RG16", "          ", GL_RG, 2, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RG16_SNORM, "GL_RG16_SNORM", "    ", GL_RG, 2, {
                                                             16,
                                                             16,
                                                             0,
                                                             0,
       ...
       true,
       BasicInternalFormatElement::FIXED_POINT},
      {GL_R3_G3_B2, "GL_R3_G3_B2", "      ", GL_RGB, 3, {
                                                            3,
                                                            3,
                                                            2,
                                                            0,
      ...
      {GL_RGB8, "GL_RGB8", "          ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RGB8_SNORM, "GL_RGB8_SNORM", "    ", GL_RGB, 3, {
                                                              8,
                                                              8,
                                                              8,
                                                              0,
      ...
      {GL_RGB16, "GL_RGB16", "         ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RGB16_SNORM, "GL_RGB16_SNORM", "   ", GL_RGB, 3, {
                                                               16,
                                                               16,
                                                               16,
                                                               0,
      ...
      {GL_RGBA4, "GL_RGBA4", "         ", GL_RGBA, 4, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RGB5_A1, "GL_RGB5_A1", "       ", GL_RGBA, 4, {
                                                            5,
                                                            5,
                                                            5,
                                                            1,
      ...
      {GL_RGBA8, "GL_RGBA8", "         ", GL_RGBA, 4, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RGBA8_SNORM, "GL_RGBA8_SNORM", "   ", GL_RGBA, 4, {
                                                                8,
                                                                8,
                                                                8,
                                                                8,
       ...
       true,
       BasicInternalFormatElement::FIXED_POINT},
      {GL_RGB10_A2, "GL_RGB10_A2", "      ", GL_RGBA, 4, {
                                                             10,
                                                             10,
                                                             10,
                                                             2,
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RGB10_A2UI, "GL_RGB10_A2UI", "    ", GL_RGBA, 4, {
                                                               10,
                                                               10,
                                                               10,
                                                               2,
       ...
       true,
       true,
       BasicInternalFormatElement::UNSIGNED_INT},
      {GL_RGBA12, "GL_RGBA12", "        ", GL_RGBA, 4, {
                                                           12,
                                                           12,
                                                           12,
                                                           12,
      ...
      {GL_RGBA16, "GL_RGBA16", "        ", GL_RGBA, 4, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_RGBA16_SNORM, "GL_RGBA16_SNORM", "  ", GL_RGBA, 4, {
                                                                 16,
                                                                 16,
                                                                 16,
                                                                 16,
      ...
      {GL_SRGB8, "GL_SRGB8", "         ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_FIXED_POINT},
      {GL_SRGB8_ALPHA8, "GL_SRGB8_ALPHA8", "  ", GL_RGBA, 4, {
                                                                 8,
                                                                 8,
                                                                 8,
                                                                 8,
      ...
      {GL_R16F, "GL_R16F", "          ", GL_RED, 1, {
       ...
       true,
       true,
       BasicInternalFormatElement::FLOAT},
      {GL_RG16F, "GL_RG16F", "         ", GL_RG, 2, {
                                                        16,
                                                        16,
                                                        0,
                                                        0,
      ...
      {GL_RGB16F, "GL_RGB16F", "        ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::FLOAT},
      {GL_RGBA16F, "GL_RGBA16F", "       ", GL_RGBA, 4, {
                                                            16,
                                                            16,
                                                            16,
                                                            16,
      ...
      {GL_RGB32F, "GL_RGB32F", "        ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::FLOAT},
      {GL_RGBA32F, "GL_RGBA32F", "       ", GL_RGBA, 4, {
                                                            32,
                                                            32,
                                                            32,
                                                            32,
       ...
       true,
       BasicInternalFormatElement::FLOAT},
      {GL_R11F_G11F_B10F, "GL_R11F_G11F_B10F", "", GL_RGB, 3, {
                                                                  11,
                                                                  11,
                                                                  10,
                                                                  0,
       ...
       true,
       BasicInternalFormatElement::FLOAT},
      {GL_RGB9_E5, "GL_RGB9_E5", "       ", GL_RGB, 4, {
                                                           9,
                                                           9,
                                                           9,
                                                           5,
      ...
      {GL_R8I, "GL_R8I", "           ", GL_RED, 1, {
       ...
       true,
       true,
       BasicInternalFormatElement::INT},
      {GL_R8UI, "GL_R8UI", "          ", GL_RED, 1, {
                                                        8,
                                                        0,
                                                        0,
                                                        0,
      ...
      {GL_RGB16I, "GL_RGB16I", "        ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::INT},
      {GL_RGB16UI, "GL_RGB16UI", "       ", GL_RGB, 3, {
                                                           16,
                                                           16,
                                                           16,
                                                           0,
      ...
      {GL_RGB32I, "GL_RGB32I", "        ", GL_RGB, 3, {
       ...
       true,
       BasicInternalFormatElement::INT},
      {GL_RGB32UI, "GL_RGB32UI", "       ", GL_RGB, 3, {
                                                           32,
                                                           32,
                                                           32,
                                                           0,
      ...
      {GL_RGBA8I, "GL_RGBA8I", "        ", GL_RGBA, 4, {
       ...
       true,
       BasicInternalFormatElement::INT},
      {GL_RGBA8UI, "GL_RGBA8UI", "       ", GL_RGBA, 4, {
                                                            8,
                                                            8,
                                                            8,
                                                            8,
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_INT},
      {GL_RGBA16I, "GL_RGBA16I", "       ", GL_RGBA, 4, {
                                                            16,
                                                            16,
                                                            16,
                                                            16,
       ...
       true,
       BasicInternalFormatElement::INT},
      {GL_RGBA16UI, "GL_RGBA16UI", "      ", GL_RGBA, 4, {
                                                             16,
                                                             16,
                                                             16,
                                                             16,
       ...
       true,
       BasicInternalFormatElement::UNSIGNED_INT},
      {GL_RGBA32I, "GL_RGBA32I", "       ", GL_RGBA, 4, {
                                                            32,
                                                            32,
                                                            32,
                                                            32,
       ...
       true,
       BasicInternalFormatElement::INT},
      {GL_RGBA32UI, "GL_RGBA32UI", "      ", GL_RGBA, 4, {
                                                             32,
                                                             32,
                                                             32,
                                                             32,
