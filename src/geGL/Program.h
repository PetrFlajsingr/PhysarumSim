...
inline void Program::set(std::string const &name, float v0) {
  assert(this != nullptr);
  this->set1f(name, v0);
}
inline void Program::set(std::string const &name, float v0, float v1) {
  assert(this != nullptr);
  this->set2f(name, v0, v1);
}
inline void Program::set(std::string const &name, float v0, float v1, float v2) {
  assert(this != nullptr);
  this->set3f(name, v0, v1, v2);
}
inline void Program::set(std::string const &name, float v0, float v1, float v2, float v3) {
  assert(this != nullptr);
  this->set4f(name, v0, v1, v2, v3);
}
inline void Program::set(std::string const &name, int32_t v0) {
  assert(this != nullptr);
  this->set1i(name, v0);
}
inline void Program::set(std::string const &name, int32_t v0, int32_t v1) {
  assert(this != nullptr);
  this->set2i(name, v0, v1);
}
inline void Program::set(std::string const &name, int32_t v0, int32_t v1, int32_t v2) {
  assert(this != nullptr);
  this->set3i(name, v0, v1, v2);
}
inline void Program::set(std::string const &name, int32_t v0, int32_t v1, int32_t v2, int32_t v3) {
  assert(this != nullptr);
  this->set4i(name, v0, v1, v2, v3);
}
inline void Program::set(std::string const &name, uint32_t v0) {
  assert(this != nullptr);
  this->set1ui(name, v0);
}
inline void Program::set(std::string const &name, uint32_t v0, uint32_t v1) {
  assert(this != nullptr);
  this->set2ui(name, v0, v1);
}
inline void Program::set(std::string const &name, uint32_t v0, uint32_t v1, uint32_t v2) {
  assert(this != nullptr);
  this->set3ui(name, v0, v1, v2);
}
inline void Program::set(std::string const &name, uint32_t v0, uint32_t v1, uint32_t v2, uint32_t v3) {
  assert(this != nullptr);
  this->set4ui(name, v0, v1, v2, v3);
}
inline void Program::set1v(std::string const &name, float const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set1fv(name, v0, count);
}
inline void Program::set2v(std::string const &name, float const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set2fv(name, v0, count);
}
inline void Program::set3v(std::string const &name, float const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set3fv(name, v0, count);
}
inline void Program::set4v(std::string const &name, float const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set4fv(name, v0, count);
}
inline void Program::set1v(std::string const &name, int32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set1iv(name, v0, count);
}
inline void Program::set2v(std::string const &name, int32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set2iv(name, v0, count);
}
inline void Program::set3v(std::string const &name, int32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set3iv(name, v0, count);
}
inline void Program::set4v(std::string const &name, int32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set4iv(name, v0, count);
}
inline void Program::set1v(std::string const &name, uint32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set1uiv(name, v0, count);
}
inline void Program::set2v(std::string const &name, uint32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set2uiv(name, v0, count);
}
inline void Program::set3v(std::string const &name, uint32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set3uiv(name, v0, count);
}
inline void Program::set4v(std::string const &name, uint32_t const *v0, GLsizei count) {
  assert(this != nullptr);
  this->set4uiv(name, v0, count);
}
